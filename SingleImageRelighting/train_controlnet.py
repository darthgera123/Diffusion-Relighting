...
def main(args):
    ...
    if args.tokenizer_name:
        tokenizer = AutoTokenizer.from_pretrained(args.tokenizer_name, revision=args.revision, \
            use_fast=False,cache_dir='/scratch/inf0/user/pgera/FlashingLights/SingleRelight/cache/')
    ...
    vae = AutoencoderKL.from_pretrained(
        args.pretrained_model_name_or_path, subfolder="vae", revision=args.revision, variant=args.variant,cache_dir='/scratch/inf0/user/pgera/FlashingLights/SingleRelight/cache/'
    )
    ...
    envmap_encoder = EnvMapEncoder(map_size=320,latent_size=64)
    envmap_encoder.to(accelerator.device)
